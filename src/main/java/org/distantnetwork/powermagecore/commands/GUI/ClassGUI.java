...
public class ClassGUI extends InventoryBuilder {
    public ClassGUI() {
        ...
        setItem(14, item, player -> {
            ...
            if (PowermageCore.playerClasses.containsKey(player.getUniqueId())) {
                player.getInventory().addItem(new ItemBuilder(Material.BOW).setName(String.format("%sArcher Bow", ChatColor.GRAY)).setItemFlags(ItemFlag.HIDE_ATTRIBUTES)
                        ...
                        .toItem());
                player.getInventory().addItem(new ItemBuilder(Material.ARROW).setItemFlags(ItemFlag.HIDE_ATTRIBUTES).setLore(String.format("%s%sCOMMON", ChatColor.GRAY, ChatColor.BOLD)).toItem());
            }
        ...
        setItem(18, new ItemBuilder(Material.ARROW).setName(String.format("%sBack to Main Menu", ChatColor.GRAY)).setItemFlags(ItemFlag.HIDE_ATTRIBUTES).toItem(), player -> new MenuGUI().open(player));
        setItem(22, new ItemBuilder(Material.BARRIER).setName(String.format("%sClose Menu", ChatColor.RED)).setItemFlags(ItemFlag.HIDE_ATTRIBUTES).toItem(), player -> player.closeInventory());
    }
}