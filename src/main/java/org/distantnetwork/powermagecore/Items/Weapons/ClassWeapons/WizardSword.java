...
public class WizardSword extends WeaponItem {
    public WizardSword() {
        super(Material.STONE_SWORD, 1, "&7Wizard Sword", Arrays.asList("The starter sword for the Wizard Class"), Arrays.asList(ItemFlag.HIDE_ATTRIBUTES, ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_UNBREAKABLE), new HashMap<Enchantment, Integer>() {{
